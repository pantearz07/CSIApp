 ...
 */
public class InvestigatorListTabFragment extends Fragment {
    CoordinatorLayout rootLayoutInv;
    FloatingActionButton fabBtnInv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        txtUpdateDate = (TextView) viewinvestigator
        ...
        //fab
        fabBtnInv = (FloatingActionButton) viewinvestigator.findViewById(R.id.fabBtnInv);
        fabBtnInv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (networkConnectivity) {

                    new SelectAllInvestigatorToSQLite().execute();
    ...
    RVAdapter.OnItemClickListener onItemClickListener = new RVAdapter.OnItemClickListener() {
        ...
        public void onItemClick(View view, int position) {
            ...
            builder.setTitle("โทรออก");
            builder.setMessage(ps.name + "\n" + ps.tel);
    ...
    private void initializeData() {
        ...
        mCursor = mDb.rawQuery("SELECT * FROM "
                ...
                + SQLiteDBHelper.COL_AccessType + " = 'investigator'", null);

        Log.i("log_show", "Show data All investigator "+mCursor.getCount());
        persons.clear();
        mCursor.moveToFirst();
    ...
    class SelectAllInvestigatorToSQLite extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            Log.i("Recieve investigator", resultServer);
            return resultServer;
        }
            ...
            try {
                ...
                for (int i = 0; i < data.length(); i++) {
                    ...
                    sAccessType = c.getString("AccessType");
                        ...
                        if (saveStatus == -1) {
                            Log.i("Recieve investigator", "Error!! ");
                        }else if(saveStatus == -2) {

                            Log.i("Recieve investigator", "had");

                        }else if(saveStatus == 0) {

                            Log.i("Recieve investigator" + i, sOfficialID + " " + sRank

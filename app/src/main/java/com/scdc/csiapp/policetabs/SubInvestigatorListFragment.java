...
public class SubInvestigatorListFragment extends Fragment {
    private static final String TAG = "DEBUG-SubInvestigatorListFragment";
    ...
    public static SubInvestigatorListFragment newInstance() {
        return new SubInvestigatorListFragment();
    }

    public SubInvestigatorListFragment() {
    }
...
//                selectApiOfficialFromSQLite();
    ...
    public void selectApiOfficialFromSQLite() {
        ApiListOfficial apiListOfficial = mDbHelper.selectApiOfficial("investigator2");

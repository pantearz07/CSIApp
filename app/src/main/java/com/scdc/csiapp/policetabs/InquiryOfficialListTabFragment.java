 ...
 */
public class InquiryOfficialListTabFragment extends Fragment {
        ...
        fabBtnIns.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (networkConnectivity) {
                    ...
                    new SelectAllInspectorToSQLite().execute();
    ...
    private void initializeData() {
        ...
        mCursor = mDb.rawQuery("SELECT * FROM "
                ...
                + SQLiteDBHelper.COL_AccessType + " = 'inquiryofficial'", null);

        Log.i("log_show", "Show data All inspector "+mCursor.getCount());
        persons.clear();
        mCursor.moveToFirst();
    ...
    class SelectAllInspectorToSQLite extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            Log.i("Recieve inspector", resultServer);
            return resultServer;
        }
        ...
        protected void onPostExecute(String resultServer) {
            ...
            try {
                ...
                for (int i = 0; i < data.length(); i++) {
                    ...
                    if (saveStatus == -1) {
                        Log.i("Recieve inspector", "Error!!");
                    }else if(saveStatus == -2) {

                        Log.i("Recieve inspector", "had");

                    }else {

                        Log.i("Recieve inspector" + i, sOfficialID + " " + sRank
